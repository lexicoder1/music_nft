...
contract BigTopGnomeSpot is IERC721A, DefaultOperatorFilterer, ERC2981,VRFConsumerBaseV2, ConfirmedOwner{
    ...
    function publicMint(uint256 amount) public payable {
        ...
        require( amount <= maxPertransaction, "exceed  max per transaction");
    ...
    function claim(uint256[] memory _tokenIds) public {
        ...
        spoilToken.mint(msg.sender,rewardbal);
    }
    ...
    function adminMint(address wallet, uint256 amount) public onlyOwner {
    ...
    function setspoilTokenAddress(address add) public onlyOwner {
